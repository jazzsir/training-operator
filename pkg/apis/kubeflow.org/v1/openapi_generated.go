...
func schema_pkg_apis_kubefloworg_v1_MPIJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/jazzsir/training-operator/pkg/apis/common/v1.JobStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.JobStatus", "github.com/jazzsir/training-operator/pkg/apis/kubeflow.org/v1.MPIJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_MPIJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"mpiReplicaSpecs": {
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/jazzsir/training-operator/pkg/apis/common/v1.ReplicaSpec"),
									},
								},
							},
						},
					...
					"runPolicy": {
						SchemaProps: spec.SchemaProps{
							Description: "`RunPolicy` encapsulates various runtime policies of the distributed training job, for example how to clean up resources and how long the job can stay active.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/jazzsir/training-operator/pkg/apis/common/v1.RunPolicy"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.ReplicaSpec", "github.com/jazzsir/training-operator/pkg/apis/common/v1.RunPolicy"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_MXJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.JobStatus", "github.com/jazzsir/training-operator/pkg/apis/kubeflow.org/v1.MXJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PaddleJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.JobStatus", "github.com/jazzsir/training-operator/pkg/apis/kubeflow.org/v1.PaddleJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PaddleJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.ReplicaSpec", "github.com/jazzsir/training-operator/pkg/apis/common/v1.RunPolicy", "github.com/jazzsir/training-operator/pkg/apis/kubeflow.org/v1.PaddleElasticPolicy"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PyTorchJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.JobStatus", "github.com/jazzsir/training-operator/pkg/apis/kubeflow.org/v1.PyTorchJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PyTorchJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.ReplicaSpec", "github.com/jazzsir/training-operator/pkg/apis/common/v1.RunPolicy", "github.com/jazzsir/training-operator/pkg/apis/kubeflow.org/v1.ElasticPolicy"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_TFJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.JobStatus", "github.com/jazzsir/training-operator/pkg/apis/kubeflow.org/v1.TFJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_XGBoostJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/jazzsir/training-operator/pkg/apis/common/v1.JobStatus", "github.com/jazzsir/training-operator/pkg/apis/kubeflow.org/v1.XGBoostJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
